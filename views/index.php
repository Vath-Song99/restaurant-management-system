<main>
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-md-6 banner-img" data-aos="fade-left" data-aos-delay="3000">
          <img class="img img-fluid mt-5 mt-lg-0" src="images/banner-img.png" alt="">
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-6 about-img-box">
          <div class="row g-3">
            ...
            <div class="col-6 text-right" data-aos="fade-down">
              <img class="img-fluid rounded w-75" src="images/about-2.jpg">
            </div>
      ...
      <div class="row our-chef-slider-wrapper py-5" data-aos="fade-left">
        <div class="col-lg-4">
          <div class="our-chef-slider d-flex flex-column align-items-center gap-4">
            <img width="200px" src="images/team-1.png" alt="">
        ...
        <div class="col-lg-4">
          <div class="our-chef-slider d-flex flex-column align-items-center gap-4">
            <img width="200px" src="images/team-2.png" alt="">
            <div class="chef-slider-content">
              <h5 class="text-center d-block">Teresa Doe</h5>
              <p class="text-center mb-0">Head Chef</p>
              <div class="d-flex justify-content-center">
        ...
        <div class="col-lg-4">
          <div class="our-chef-slider d-flex flex-column align-items-center gap-4">
            <img width="200px" src="images/team-3.png" alt="">
            <div class="chef-slider-content">
              <h5 class="text-center d-block">Teresa Doe</h5>
              <p class="text-center mb-0">Head Chef</p>
              <div class="d-flex justify-content-center">
        ...
        <div class="col-lg-4">
          <div class="our-chef-slider d-flex flex-column align-items-center gap-4">
            <img width="200px" src="images/team-4.png" alt="">
            <div class="chef-slider-content">
              <h5 class="text-center d-block">Teresa Doe</h5>
              <p class="text-center mb-0">Head Chef</p>
              <div class="d-flex justify-content-center">
  ...
  <section class="reservation">
    <img class="d-md-none d-lg-block" src="images/find-a-table.png" alt="">
      ...
      <div class="row pt-5">
        <div class="col-lg-4 mb-5 mb-lg-0">
          <div class="card" data-aos="fade-up-right">
            ...
            <div class="blog-featured-img">
              <img class="w-100" src="images/blog-grid-1.jpg" alt="">
            </div>
            <div class="blog-content px-4 pt-5 pb-4 position-relative">
              ...
              <p class="blog-description">
                Lorem ipsum dolor sit amet, consectetur, sed do eiusmod tempor incididunt ut labore et dolore magna
                aliqua.
              </p>
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          <div class="card" data-aos="fade-down">
            ...
            <div class="blog-featured-img">
              <img class="w-100" src="images/blog-grid-1-1.jpg" alt="">
            </div>
            <div class="blog-content px-4 pt-5 pb-4 position-relative">
              <div class="blog-date">
                <span class="day">12</span>
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          <div class="card" data-aos="fade-up-left">
            ...
            <div class="blog-featured-img">
              <img class="w-100" src="images/blog-grid-1-2.jpg" alt="">
            </div>
            <div class="blog-content px-4 pt-5 pb-4 position-relative">
              <div class="blog-date">
                <span class="day">12</span>
