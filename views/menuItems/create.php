...
<div class="container-fluid py-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= BASE_URL?>/dashboard/menu-items/create" method="post">
                <div class="mb-3">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" class="form-control <?= isset($errors['name']) ? 'is-invalid' : '' ?>" id="name" name="name" value="<?= htmlspecialchars($menuItem['name']) ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control <?= isset($errors['price']) ? 'is-invalid' : '' ?>" id="price" name="price" value="<?= htmlspecialchars($menuItem['price']) ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= isset($errors['description']) ? 'is-invalid' : '' ?>" id="description" name="description" rows="4" required><?= htmlspecialchars($menuItem['description']) ?></textarea>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input" id="available" name="available" <?= $menuItem['available'] ? 'checked' : '' ?>>
