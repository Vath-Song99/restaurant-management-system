<main class="about-page">
          ...
          <div class="story-indicators my-4">
            <div class="row">
              <div data-aos="fade-right" class="image-box col-lg-2 px-0">
                <img class="w-100" src="images/timeline-1.jpg" alt="" />
                <div class="image-box-inner">
                  <p class="mb-0">2000</p>
                </div>
              </div>
              <div data-aos="fade-down" class="image-box col-lg-2 px-0">
                <img class="w-100" src="images/timeline-2.jpg" alt="" />
                <div class="image-box-inner">
                  <p class="mb-0">2002</p>
                </div>
              ...
              <div data-aos="fade-up" class="image-box col-lg-2 px-0">
                <img class="w-100" src="images/timeline-3.jpg" alt="" />
                <div class="image-box-inner">
                  <p class="mb-0">2004</p>
                </div>
              </div>
              <div data-aos="fade-down" class="image-box col-lg-2 px-0">
                <img class="w-100" src="images/timeline-4.jpg" alt="" />
                <div class="image-box-inner">
                  <p class="mb-0">2008</p>
                </div>
              ...
              <div data-aos="fade-up" class="image-box col-lg-2 px-0">
                <img class="w-100" src="images/timeline-5.jpg" alt="" />
                <div class="image-box-inner">
                  <p class="mb-0">2012</p>
                </div>
              ...
              <div data-aos="fade-left" class="image-box col-lg-2 px-0">
                <img class="w-100" src="images/timeline-6.jpg" alt="" />
                <div class="image-box-inner">
                  <p class="mb-0">2016</p>
                </div>
          ...
          <div class="story-content py-5 my-4" data-aos="fade-right">
            <div>
              ...
              <p class="text-center">
                ...
                dolore magna aliqua. Ut enim ad minim veniam, quis nosrud lorem exercitation ullamco laboris nisi ut
    ...
    <div class="container my-2 py-2 mt-lg-4 pt-lg-4 mb-lg-0 pb-lg-0">
      <div class="row">
        <div class="col-lg-4 d-none d-lg-block">
          <img src="images/ab_team_01.png" alt="" data-aos="fade-right">
        </div>
            ...
            <div class="slider-content pt-5 pb-4 mx-4" data-aos="fade-down-left">
              <div>
                ...
                <div class="d-flex justify-content-center mb-3">
                  <img src="images/testi-signal.png" alt="">
                </div>
          ...
          <div class="special-card" data-aos="fade-right">
            <div class="box-inner">
              <div class="box-wrapper px-4">
                ...
                <p class="pb-4">Lorem ipsum dolor sit amet, consec adipisicing elit, sed do eiusmod tempor incididunt ut
              ...
              <div class="box-showcase pb-5">
                <div class="d-flex flex-column align-items-center justify-content-center">
                  <img class="img-fluid" src="images/feature-box-bg.jpg" alt="">
        ...
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
          <div class="special-card" data-aos="flip-right">
            <div class="box-inner">
              ...
              <div class="box-showcase pb-5">
                <div class="d-flex flex-column align-items-center justify-content-center">
                  <img class="img-fluid" src="images/feature-box-bg-2.jpg" alt="">
        ...
        <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
          <div class="special-card" data-aos="fade-left">
            <div class="box-inner">
              ...
              <div class="box-showcase pb-5">
                <div class="d-flex flex-column align-items-center justify-content-center">
                  <img class="img-fluid" src="images/feature-box-bg-3.jpg" alt="">
  ...
  <section class="our-partner my-5">
    <div class="container partner-slider py-5" data-aos="fade-up-left">
      <div class="d-flex justify-content-center">
        <img class="img-fluid" src="images/partner-01.png" alt="">
      </div>
      <div class="d-flex justify-content-center">
        <img class="img-fluid" src="images/partner-02.png" alt="">
      </div>
      <div class="d-flex justify-content-center">
        <img class="img-fluid" src="images/partner-03.png" alt="">
      </div>
      <div class="d-flex justify-content-center">
        <img class="img-fluid" src="images/partner-04.png" alt="">
      </div>
      <div class="d-flex justify-content-center">
        <img class="img-fluid" src="images/partner-01.png" alt="">
      </div>
  ...
  <section class="counter my-5">
    <img data-aos="fade-right" class="counter-after" src="images/vegetable_01.png" alt="">
    <img data-aos="fade-right" class="counter-before" src="images/vegetable_02.png" alt="">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <form action="" class="position-relative">
            <p class="text-center" data-aos="fade-up-right">We willing to help you make the reservation online to save
              your time and money or you can call us directly through the customer service hotline: 225-88888</p>
            <div class="row mt-5">
