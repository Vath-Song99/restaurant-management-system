...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= BASE_URL ?>/dashboard/reservations/edit/<?= $reservation->id ?>" method="post">
                <div class="mb-3">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" class="form-control <?= isset($errors['name']) ? 'is-invalid' : '' ?>" id="name"
                        name="name" value="<?= htmlspecialchars($reservation->name ?? '') ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control <?= isset($errors['email']) ? 'is-invalid' : '' ?>" id="email"
                        name="email" value="<?= htmlspecialchars($reservation->email ?? '') ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= isset($errors['phone']) ? 'is-invalid' : '' ?>" id="phone"
                        name="phone" value="<?= htmlspecialchars($reservation->phone ?? '') ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control <?= isset($errors['num_guests']) ? 'is-invalid' : '' ?>"
                        id="num_guests" name="num_guests" value="<?= htmlspecialchars($reservation->num_guests ?? '') ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" class="form-control <?= isset($errors['reservation_time']) ? 'is-invalid' : '' ?>"
                        id="reservation_time" name="reservation_time"
                        value="<?= htmlspecialchars(date('Y-m-d\TH:i', strtotime($reservation->reservation_time ?? ''))) ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= isset($errors['special_requests']) ? 'is-invalid' : '' ?>"
                        id="special_requests" name="special_requests" rows="4"><?= htmlspecialchars($reservation->special_requests ?? '') ?></textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= isset($errors['description']) ? 'is-invalid' : '' ?>"
                        id="description" name="description" rows="4" required><?= htmlspecialchars($reservation->description ?? '') ?></textarea>
