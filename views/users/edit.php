...
<div class="container-fluid py-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= BASE_URL ?>/dashboard/users/edit/<?= $user->id ?>" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select <?= isset($errors['role_id']) ? 'is-invalid' : '' ?>" id="role_id"
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select <?= isset($errors['is_active']) ? 'is-invalid' : '' ?>" id="is_active"
